...
//
//  Created by Ehsan Zaman on 6/24/16.
...
@property (weak, nonatomic) IBOutlet UILabel *Flatiron;
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    FISLocation *certainLocation = self.locations[indexPath];
    FISTriviaTableViewController *destinationVC = segue.destinationViewController;
    destinationVC.trivia = certainLocation.trivia;
